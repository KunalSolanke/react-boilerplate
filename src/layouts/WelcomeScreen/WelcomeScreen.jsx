                    ...
                    <div className="container">
                        <div className="hero-inner">
                            <div className="hero-copy">
                                <h1 className="hero-title mt-0 is-revealing">Welcome to SWC Teams</h1>
                                <p className="hero-paragraph is-revealing">We aim to achieve hassle free deployments and montioring
                                    of applictions over SWC servers.</p>
                            ...
                            <div className="features-wrap">
                                <div className="feature">
                                    <div className="feature-inner">
                                        ...
                                        <p className="text-sm mb-0">Deploy your applications easily and tracks bugs in production
                                            with ease on our main site.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <footer className="site-footer">
                ...
                <div className="container">
                    <div className="site-footer-inner has-top-divider">
                        <div className="footer-copyright">&copy; SWC</div>
